...
class _Prescriptions2State extends State<Prescriptions2> {
  ...
  getPharmacistInfo() async {
    await FirebaseFirestore.instance
      ...
      pharmacistPhoneNumber = doc.data()['phone-number'];
      if (doc.data()['speciality'] == 'صيدلي') {
        pharmacistSpeciality = 'pharmacist';
      } else if (doc.data()['speciality'] == 'صيدلي إكلينيكي') {
        doctorSpeciality = 'clinical pharmacist';
      } else {
        pharmacistSpeciality = 'consultant pharmacist';
      }
      if (mounted) {
        setState(() {});
      }
              ...
              child: StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.data.docs.length == 0) {
                      ...
                      //     ['Acetylsalicylicacid', 'Warfarin', 'Atenolol']);
