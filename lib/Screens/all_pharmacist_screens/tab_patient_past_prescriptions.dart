...
class PastPrescriptionsPh extends StatefulWidget {
  PastPrescriptionsPh({this.uid});
  final String uid;
  @override
  _PastPrescriptionsPhState createState() => _PastPrescriptionsPhState();
}

class _PastPrescriptionsPhState extends State<PastPrescriptionsPh> {
  String searchValue = '';
                                  ...
                                  builder: (context, snapshot) {
                                    if (!snapshot.hasData) {
                                      return Center(
                                          child: CircularProgressIndicator(
                                              backgroundColor: klighterColor,
                                              valueColor: AlwaysStoppedAnimation(klighterColor))
                                      );
                                    }
