                            ...
                            child: TextFormField(
                              ...
                              onSaved: (value) {
                                ...
                                if (eq(valueAsList, medAllergyVal) == false) {
                                  setState(() {
                                    medicalHistory.reference.update(
                                        {'medication allergies': valueAsList});
                                    this.somethingChanged = true;
                                  });
                                }
                              },
                                      ...
                                      onPressed: () {
                                        ...
                                        if (somethingChanged) {
                                          ...
                                          Flushbar(
                                            ...
                                            messageText: Text(
                                              ' تم تعديل السجل الطبي الخاص بك بنجاح',
                                              style: TextStyle(
                                                color: kBlueColor,
                                                fontFamily: 'Almarai',
                                              ),
