        ...
        children: [
          ...
          Padding(
            ...
            child: RaisedButton(
                child: Text(birthDate == null
                    ? 'اختر تاريخ ميلادك'
                    : birthDate.toString()), //if not null display the date
                onPressed: () {
                  showDatePicker(
                          context: context,
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              // onSaved: (value) {
              //   patientFullName = int.parse(value);;
              // },
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'افصل بين كل سبب بعلامة /',
                border:
                    OutlineInputBorder(), //fillColor: Colors.red, //suffix: Icon(Icons.add),
              ),
              onChanged: (value) {
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'افصل بين كل عملية بعلامة /',
                border:
                    OutlineInputBorder(), //fillColor: Colors.red, //suffix: Icon(Icons.add),
              ),
              onChanged: (value) {
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'اذكر الأمور التي تثيرها',
                border:
                    OutlineInputBorder(), //fillColor: Colors.red, //suffix: Icon(Icons.add),
              ),
              onChanged: (value) {
